...
* **Version actuelle** _(stable)_: **v5.0**
* Prochaine version _(dev)_: _v5.1_
...
Jeter un coup d'œil à [Changelog.md](https://github.com/toulousain79/MySB/blob/v5.1/Changelog.md), tout est là.
