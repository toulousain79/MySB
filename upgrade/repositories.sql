INSERT INTO `repositories` (`type`, `dir`, `name`, `version`, `upgrade`, `file`, `url`, `active`, `proxy_use`) VALUES
('GIT', '<InstallDir>/web/apps/ru', 'ruTorrent', '3.8', 0, 'ruTorrent_v3.8.zip', 'https://github.com/Novik/ruTorrent', 1, 0),
...
('CURL', '/usr/bin/composer', 'Composer', '1.5.2', 0, 'composer.phar', 'https://getcomposer.org/download/1.5.2/composer.phar', 1, 1),
('TARGZ', '<InstallDir>/sources/nodejs', 'NodeJS', '0.12.18', 0, 'node_v0.12.18.tar.gz', 'https://nodejs.org/dist/latest-v0.12.x/node-v0.12.18.tar.gz', 1, 1),
...
('TARGZ', '<InstallDir>/sources/libsodium', 'Libsodium', '1.0.15', 0, 'libsodium_v1.0.15.tar.gz', 'https://download.libsodium.org/libsodium/releases/libsodium-1.0.15.tar.gz', 1, 1),
('TARGZ', '<InstallDir>/sources/minisign', 'Minisign', '0.7.11', 0, 'minisign_v0.7.11.tar.gz', 'https://github.com/jedisct1/minisign/tarball/master', 1, 1),
('TARGZ', '<InstallDir>/sources/dnscrypt-proxy', 'DNScrypt-proxy', '1.9.5', 0, 'dnscrypt-proxy_v1.9.5.tar.gz', 'https://download.dnscrypt.org/dnscrypt-proxy/dnscrypt-proxy-1.9.5.tar.gz', 1, 1),
...
('WBM', '<InstallDir>/files', 'Nginx Webmin Module', '0.10', 0, 'nginx_v0.10.wbm', 'https://www.justindhoffman.com/sites/justindhoffman.com/files/nginx-0.10.wbm_.gz', 1, 1),
...
('GIT', '<InstallDir>/web/apps/la', 'LoadAvg', '2.2', 0, 'loadavg_v2.2.zip', 'https://github.com/loadavg/loadavg.git', 1, 0),
...
('TARGZ', '<InstallDir>/sources/rkhunter', 'RKHunter', '1.4.4', 0, 'rkhunter_v1.4.4.tar.gz', 'https://downloads.sourceforge.net/project/rkhunter/rkhunter/1.4.4/rkhunter-1.4.4.tar.gz?r=https%3A%2F%2Fsourceforge.net%2Fprojects%2Frkhunter%2Ffiles%2Frkhunter%2F1.4.4%2F&ts=1500813184&use_mirror=kent', 1, 1),
('TARGZ', '<InstallDir>/sources/wget', 'Wget', '1.19.2', 0, 'wget_v1.19.2.tar.gz', 'http://ftp.gnu.org/gnu/wget/wget-1.19.2.tar.gz', 1, 1),
('TARGZ', '<InstallDir>/sources/geoipupdate', 'GeoIPupdate', '2.5.0', 0, 'GeoIPupdate_v2.5.0.tar.gz', 'https://github.com/maxmind/geoipupdate/releases/download/v2.5.0/geoipupdate-2.5.0.tar.gz', 1, 1),
('ZIP', '<InstallDir>/web/wolf', 'Wolf CMS', '0.8.3.1', 0, 'wolf_v0.8.3.1.zip', 'https://github.com/toulousain79/MySB/raw/v5.1/files/wolf_v0.8.3.1.zip', 1, 1),
