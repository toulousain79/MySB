	Version v3.2
		2016/01/31
			...
			- Add possibility to use personal scripts for each ended download (ex: rsync to your NAS directly) (v3.2)
			- MySB portal, add possibility to create sub-directories for rTorrent ended files (v3.2)
