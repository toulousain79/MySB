...
('TARGZ', '/opt/Lynis', 'Lynis', '2.7.5', 0, 'lynis_v2.7.5.tar.gz', 'https://downloads.cisofy.com/lynis/lynis-${gsVersionLatest}.tar.gz', 1, 0, ''),
...
('TARGZ', '<InstallDir>/sources/netdata', 'NetData', '1.17.1', 0, 'netdata_v1.17.1.tar.gz', 'https://github.com/netdata/netdata/releases/download/v1.17.1/netdata-v1.17.1.tar.gz', 1, 0, ''),
