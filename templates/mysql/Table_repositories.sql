...
('GIT', '/tmp/rutorrent_dev', 'ruTorrent Dev', 'dev', 0, 'ruTorrent_dev.zip', 'https://github.com/Novik/ruTorrent.git', 1, 0, ''),
...
('CURL', '/usr/bin/composer', 'Composer', 'latest', 0, 'composer.phar', 'https://github.com/composer/composer/releases/latest', 1, 0, ''),
('CURL', '/usr/bin/docker-compose', 'Docker-Compose', 'latest', 0, 'docker-compose', 'https://api.github.com/repos/docker/compose/releases/latest', 1, 0, ''),
...
('TARGZ', '<InstallDir>/sources/minisign', 'Minisign', '0.8.3', 0, 'minisign_v0.8.2.tar.gz', 'https://github.com/jedisct1/minisign/tarball/master', 1, 0, ''),
