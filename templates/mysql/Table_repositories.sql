...
('ZIP', '<InstallDir>/web/apps/ru/plugins/filemanager', 'ruTorrent Plugin FileManager', '0.09', 0, 'filemanager_v0.09.zip', 'https://github.com/toulousain79/MySB_files/raw/v5.3/filemanager_v0.09.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileupload', 'ruTorrent Plugin FileUpload', '0.02', 0, 'fileupload_v0.02.zip', 'https://github.com/toulousain79/MySB_files/raw/v5.3/fileupload_v0.02.zip', 0, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileshare', 'ruTorrent Plugin FileShare', '1.0', 0, 'fileshare_v1.0.zip', 'https://github.com/toulousain79/MySB_files/raw/v5.3/fileshare_v0.03.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/mediastream', 'ruTorrent Plugin MediaStream', '0.01', 0, 'mediastream_v0.01.zip', 'https://github.com/toulousain79/MySB_files/raw/v5.3/mediastream_v0.01.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/ru/plugins/pausewebui', 'ruTorrent Plugin Pause WebUI', '1.2', 0, 'pausewebui_v1.2.zip', 'https://github.com/toulousain79/MySB_files/raw/v5.3/pausewebui_v1.2.zip', 1, 0, ''),
...
('CURL', '/usr/bin/composer', 'Composer', '1.7.2', 0, 'composer.phar', 'https://getcomposer.org/download/1.7.2/composer.phar', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/nc', 'NextCloud', '13.0.6', 0, 'nextcloud_v13.0.6.zip', 'https://download.nextcloud.com/server/releases/nextcloud-13.0.6.zip', 1, 0, ''),
('TARGZ', '<InstallDir>/sources/rkhunter', 'RKHunter', '1.4.6', 0, 'rkhunter_v1.4.6.tar.gz', 'https://github.com/toulousain79/MySB_files/raw/v5.3/rkhunter_v1.4.6.tar.gz', 1, 0, ''),
('TARGZ', '<InstallDir>/sources/geoipupdate', 'GeoIPupdate', '3.1.0', 0, 'GeoIPupdate_v3.1.0.tar.gz', 'https://github.com/maxmind/geoipupdate/releases/download/v3.1.0/geoipupdate-3.1.0.tar.gz', 1, 0, ''),
('ZIP', '<InstallDir>/web/wolf', 'Wolf CMS', '0.8.3.1', 0, 'wolf_v0.8.3.1.zip', 'https://github.com/toulousain79/MySB_files/raw/v5.3/wolf_v0.8.3.1.zip', 1, 0, ''),
('TARGZ', '<InstallDir>/web/apps/tt', 'Tautulli', '2.1.25', 0, 'Tautulli_v2.1.25.tar.gz', 'https://github.com/Tautulli/Tautulli/archive/v2.1.25.tar.gz', 1, 0, ''),
...
('DEB', '<InstallDir>_files', 'Plex Media Server', '1.13.9.5456-ecd600442', 0, 'plexmediaserver_1.13.9.5456-ecd600442_amd64.deb', 'https://downloads.plex.tv/plex-media-server/1.13.9.5456-ecd600442/plexmediaserver_1.13.9.5456-ecd600442_amd64.deb', 1, 0, ''),
...
('DEB', '<InstallDir>_files', 'Webmin', '1.890', 0, 'webmin_1.890_all.deb', 'http://prdownloads.sourceforge.net/webadmin/webmin_1.890_all.deb', 1, 0, '');
