...
('ZIP', '<InstallDir>/web/apps/ru', 'ruTorrent', '3.9_718087a', 1, 'ruTorrent_v3.9_718087a.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.0/ruTorrent_v3.9_718087a.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/ru/plugins/filemanager', 'ruTorrent Plugin FileManager', '0.09', 0, 'filemanager_v0.09.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.0/filemanager_v0.09.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileupload', 'ruTorrent Plugin FileUpload', '0.02', 0, 'fileupload_v0.02.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.0/fileupload_v0.02.zip', 0, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileshare', 'ruTorrent Plugin FileShare', '1.0', 0, 'fileshare_v1.0.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.0/fileshare_v0.03.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/mediastream', 'ruTorrent Plugin MediaStream', '0.01', 0, 'mediastream_v0.01.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.0/mediastream_v0.01.zip', 0, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/ru/plugins/pausewebui', 'ruTorrent Plugin Pause WebUI', '1.2', 0, 'pausewebui_v1.2.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.0/pausewebui_v1.2.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/sources/libtorrent', 'LibTorrent', '0.13.8_9bbbee6', 0, 'libtorrent_v0.13.8_9bbbee6.zip', 'https://github.com/rakshasa/rtorrent/releases/download/v0.9.8/libtorrent-0.13.8.tar.gz', 1, 0, ''),
('ZIP', '<InstallDir>/sources/rtorrent', 'rTorrent', '0.9.8_14d7121', 0, 'rtorrent_v0.9.8_14d7121.zip', 'https://github.com/rakshasa/rtorrent/releases/download/v0.9.8/rtorrent-0.9.8.tar.gz', 1, 0, ''),
('ZIP', '<InstallDir>/web/wolf', 'Wolf CMS', '0.8.3.1', 1, 'wolf_v0.8.3.1.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.0/wolf_v0.8.3.1.zip', 1, 0, ''),
...
('TARGZ', '<InstallDir>/sources/rkhunter', 'RKHunter', '1.4.6', 0, 'rkhunter_v1.4.6.tar.gz', 'https://github.com/toulousain79/MySB_files/raw/v7.0/rkhunter_v1.4.6.tar.gz', 1, 0, ''),
...
('TARGZ', '<InstallDir>/sources/netdata', 'NetData', '1.16.0', 0, 'netdata_v1.16.0.tar.gz', 'https://github.com/netdata/netdata/releases/download/v1.16.0/netdata-v1.16.0.tar.gz', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/nc', 'NextCloud', '16.0.4', 0, 'nextcloud_v16.0.4.zip', 'https://download.nextcloud.com/server/releases/nextcloud-16.0.4.zip', 1, 0, '');
