...
('ZIP', '<InstallDir>/web/apps/ru', 'ruTorrent', '3.9_cdb4cfe', 0, 'ruTorrent_v3.9_cdb4cfe.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.1/ruTorrent_v3.9_cdb4cfe.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/ru/plugins/filemanager', 'ruTorrent Plugin FileManager', '0.09', 0, 'filemanager_v0.09.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.1/filemanager_v0.09.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileupload', 'ruTorrent Plugin FileUpload', '0.02', 0, 'fileupload_v0.02.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.1/fileupload_v0.02.zip', 0, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileshare', 'ruTorrent Plugin FileShare', '1.0', 0, 'fileshare_v1.0.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.1/fileshare_v0.03.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/mediastream', 'ruTorrent Plugin MediaStream', '0.01', 0, 'mediastream_v0.01.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.1/mediastream_v0.01.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/ru/plugins/pausewebui', 'ruTorrent Plugin Pause WebUI', '1.2', 0, 'pausewebui_v1.2.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.1/pausewebui_v1.2.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/sources/libtorrent', 'LibTorrent', '0.13.8_3cec247', 0, 'libtorrent_v0.13.8_3cec247.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.1/libtorrent_v0.13.8_3cec247.zip', 1, 0, ''),
('ZIP', '<InstallDir>/sources/rtorrent', 'rTorrent', '0.9.8_8ac98c6', 0, 'rtorrent_v0.9.8_8ac98c6.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.1/rtorrent_v0.9.8_8ac98c6.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/wolf', 'Wolf CMS', '0.8.3.1', 0, 'wolf_v0.8.3.1.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.1/wolf_v0.8.3.1.zip', 1, 0, ''),
...
('CURL', '/usr/local/bin/goofys', 'Goofys', 'v0.21.0', 0, 'goofys', 'https://github.com/kahing/goofys/releases/download/v0.21.0/goofys', 1, 0, ''),
...
('TARGZ', '<InstallDir>/sources/rkhunter', 'RKHunter', '1.4.6', 0, 'rkhunter_v1.4.6.tar.gz', 'https://github.com/toulousain79/MySB_files/raw/v7.1/rkhunter_v1.4.6.tar.gz', 1, 0, ''),
