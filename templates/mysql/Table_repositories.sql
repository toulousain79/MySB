...
('CURL', '/usr/bin/composer', 'Composer', '1.8.0', 0, 'composer.phar', 'https://getcomposer.org/download/1.8.0/composer.phar', 1, 0, ''),
...
('TARGZ', '<InstallDir>/sources/minisign', 'Minisign', '0.8.3', 0, 'minisign_v0.8.3.tar.gz', 'https://github.com/jedisct1/minisign/tarball/master', 1, 0, ''),
