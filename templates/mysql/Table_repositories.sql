...
('CURL', '/usr/bin/minio', 'Minio', 'latest', 0, 'goofys', 'https://api.github.com/repos/minio/minio/releases/latest', 1, 0, ''),
('CURL', '/usr/bin/goofys', 'Goofys', 'latest', 0, 'goofys', 'https://api.github.com/repos/kahing/goofys/releases/latest', 1, 0, ''),
