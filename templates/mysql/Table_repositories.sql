...
('ZIP', '<InstallDir>/web/apps/ru', 'ruTorrent', '3.9_a21ee8b', 0, 'ruTorrent_v3.9_a21ee8b.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.2/ruTorrent_v3.9_a21ee8b.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/ru/plugins/filemanager', 'ruTorrent Plugin FileManager', '0.09', 0, 'filemanager_v0.09.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.2/filemanager_v0.09.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileupload', 'ruTorrent Plugin FileUpload', '0.02', 0, 'fileupload_v0.02.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.2/fileupload_v0.02.zip', 0, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileshare', 'ruTorrent Plugin FileShare', '1.0', 0, 'fileshare_v1.0.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.2/fileshare_v0.03.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/mediastream', 'ruTorrent Plugin MediaStream', '0.01', 0, 'mediastream_v0.01.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.2/mediastream_v0.01.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/ru/plugins/pausewebui', 'ruTorrent Plugin Pause WebUI', '1.2', 0, 'pausewebui_v1.2.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.2/pausewebui_v1.2.zip', 1, 0, ''),
...
('GIT', '<InstallDir>/web/apps/ru/plugins/linkseedboxmanager', 'ruTorrent Plugin Link Manager', '1.0', 0, 'linkseedboxmanager_v1.0.zip', 'https://github.com/Hydrog3n/linkseedboxmanager.git', 0, 0, ''),
('GIT', '<InstallDir>/web/apps/ru/plugins/linkcakebox', 'ruTorrent Plugin Link Cakebox', '1.0', 0, 'linkcakebox_v1.0.zip', 'https://github.com/Cakebox/linkcakebox.git', 0, 0, ''),
...
('ZIP', '<InstallDir>/sources/libtorrent', 'LibTorrent', '0.13.8_c791ea3', 0, 'libtorrent_v0.13.8_c791ea3.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.2/libtorrent_v0.13.8_c791ea3.zip', 1, 0, ''),
('ZIP', '<InstallDir>/sources/rtorrent', 'rTorrent', '0.9.8_7976576', 0, 'rtorrent_v0.9.8_7976576.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.2/rtorrent_v0.9.8_7976576.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/wolf', 'Wolf CMS', '0.8.3.1', 0, 'wolf_v0.8.3.1.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.2/wolf_v0.8.3.1.zip', 1, 0, ''),
...
('CURL', '/usr/local/bin/ctop', 'CTop', '0.7.3', 0, 'ctop-0.7.3-linux-amd64', 'https://github.com/bcicen/ctop/releases/download/v0.7.3/ctop-0.7.3-linux-amd64', 1, 0, ''),
...
('CURL', '/usr/local/bin/composer', 'Composer', '1.9.2', 0, 'composer.phar', 'https://getcomposer.org/download/1.9.2/composer.phar', 1, 0, ''),
...
/* ('CURL', '/usr/local/bin/goofys', 'Goofys', 'latest', 0, 'goofys', 'https://api.github.com/repos/kahing/goofys/releases/latest', 1, 0, ''), */
('CURL', '/usr/local/bin/goofys', 'Goofys', 'v0.23.1', 0, 'goofys', 'https://github.com/kahing/goofys/releases/download/v0.23.1/goofys', 1, 0, ''),
...
('GIT', '<InstallDir>/web/apps/sm', 'Seedbox-Manager', '3.0.1', 0, 'seedbox-manager_v3.0.1.zip', 'https://github.com/Magicalex/seedbox-manager.git', 0, 0, ''),
('GIT', '<InstallDir>/web/apps/cb', 'Cakebox-Light', '1.8.6', 0, 'cakebox-light_v1.8.6.zip', 'https://github.com/Cakebox/Cakebox-light.git', 0, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/nc', 'NextCloud', '18.0.0', 0, 'nextcloud_v18.0.0.zip', 'https://download.nextcloud.com/server/releases/nextcloud-18.0.0.zip', 1, 0, '');
