...
('ZIP', '<InstallDir>/web/apps/ru', 'ruTorrent', '3.9', 1, 'ruTorrent_v3.9.zip', 'https://github.com/toulousain79/MySB_files/raw/v6.0/ruTorrent_v3.9.zip', 1, 0, ''),
...
('GIT', '<InstallDir>/web/apps/ru/plugins/ratiocolor', 'ruTorrent Plugin RatioColor', '0.5', 0, 'ratiocolor_v0.5.zip', 'https://github.com/Gyran/rutorrent-ratiocolor.git', 1, 0, ''),
...
('GIT', '<InstallDir>/web/apps/ru/plugins/for_rsync', 'ruTorrent Plugin Mark for Rsync', '3.3', 0, 'for_rsync_v3.3.zip', 'https://github.com/InAnimaTe/for_rsync.git', 1, 0, ''),
