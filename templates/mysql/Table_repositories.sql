...
('ZIP', '<InstallDir>/web/apps/ru', 'ruTorrent', '3.10_3d3960b', 0, 'ruTorrent_v3.10_3d3960b.zip', 'https://github.com/toulousain79/MySB_files/raw/v99.99/ruTorrent_v3.10_3d3960b.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/sources/libtorrent', 'LibTorrent', '0.13.8_c791ea3', 0, 'libtorrent_v0.13.8_c791ea3.zip', 'https://github.com/toulousain79/MySB_files/raw/v99.99/libtorrent_v0.13.8_c791ea3.zip', 1, 0, ''),
('ZIP', '<InstallDir>/sources/rtorrent', 'rTorrent', '0.9.8_7976576', 0, 'rtorrent_v0.9.8_7976576.zip', 'https://github.com/toulousain79/MySB_files/raw/v99.99/rtorrent_v0.9.8_7976576.zip', 1, 0, ''),
...
('CURL', '/usr/local/bin/composer', 'Composer', '2.0.6', 0, 'composer.phar', 'https://getcomposer.org/download/2.0.6/composer.phar', 1, 0, ''),
...
('TARXZ', '<InstallDir>_files', 'Shellcheck', '0.7.1', 0, 'shellcheck-v0.7.1.linux.x86_64.tar.xz', 'https://storage.googleapis.com/shellcheck/shellcheck-v0.7.1.linux.x86_64.tar.xz', 1, 0, ''),
...
('DEB', '<InstallDir>_files', 'GeoIPupdate', '4.5.0', 0, 'geoipupdate_4.5.0_linux_amd64.deb', 'https://github.com/maxmind/geoipupdate/releases/download/v4.5.0/geoipupdate_4.1.5_linux_amd64.deb', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/nc', 'NextCloud', '19.0.4', 0, 'nextcloud_v19.0.4.zip', 'https://download.nextcloud.com/server/releases/nextcloud-19.0.4.zip', 1, 0, '');
