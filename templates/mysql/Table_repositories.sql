...
('CURL', '/usr/bin/composer', 'Composer', '1.6.4', 0, 'composer.phar', 'https://getcomposer.org/download/1.6.4/composer.phar', 1, 0, ''),
...
('SVN', '<InstallDir>/sources/xmlrpc-c', 'XMLRPC', '1.43.7', 0, 'xmlrpc-c_v1.43.7.zip', 'http://svn.code.sf.net/p/xmlrpc-c/code/stable/', 1, 0, ''),
