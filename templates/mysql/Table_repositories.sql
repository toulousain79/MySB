...
('ZIP', '<InstallDir>/web/apps/ru', 'ruTorrent', '3.9_626ba3d', 1, 'ruTorrent_v3.9_626ba3d.zip', 'https://github.com/toulousain79/MySB_files/raw/v5.4/ruTorrent_v3.9_626ba3d.zip', 1, 0, ''),
