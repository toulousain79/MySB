...
('ZIP', '<InstallDir>/web/apps/ru', 'ruTorrent', '3.10_48bf3e5', 0, 'ruTorrent_v3.10_48bf3e5.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.3/ruTorrent_v3.10_48bf3e5.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/ru/plugins/filemanager', 'ruTorrent Plugin FileManager', '0.09', 0, 'filemanager_v0.09.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.3/filemanager_v0.09.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileupload', 'ruTorrent Plugin FileUpload', '0.02', 0, 'fileupload_v0.02.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.3/fileupload_v0.02.zip', 0, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileshare', 'ruTorrent Plugin FileShare', '1.0', 0, 'fileshare_v1.0.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.3/fileshare_v0.03.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/mediastream', 'ruTorrent Plugin MediaStream', '0.01', 0, 'mediastream_v0.01.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.3/mediastream_v0.01.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/ru/plugins/pausewebui', 'ruTorrent Plugin Pause WebUI', '1.2', 0, 'pausewebui_v1.2.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.3/pausewebui_v1.2.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/sources/libtorrent', 'LibTorrent', '0.13.8_c791ea3', 0, 'libtorrent_v0.13.8_c791ea3.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.3/libtorrent_v0.13.8_c791ea3.zip', 1, 0, ''),
('ZIP', '<InstallDir>/sources/rtorrent', 'rTorrent', '0.9.8_7976576', 0, 'rtorrent_v0.9.8_7976576.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.3/rtorrent_v0.9.8_7976576.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/wolf', 'Wolf CMS', '0.8.3.1', 0, 'wolf_v0.8.3.1.zip', 'https://github.com/toulousain79/MySB_files/raw/v7.3/wolf_v0.8.3.1.zip', 1, 0, ''),
...
('CURL', '/usr/local/bin/ctop', 'CTop', '0.7.5', 0, 'ctop-0.7.5-linux-amd64', 'https://github.com/bcicen/ctop/releases/download/v0.7.3/ctop-0.7.3-linux-amd64', 1, 0, ''),
('CURL', '/usr/local/bin/composer', 'Composer', '2.0.7', 0, 'composer.phar', 'https://getcomposer.org/download/2.0.7/composer.phar', 1, 0, ''),
('CURL', '/usr/local/bin/minio', 'Minio', 'latest', 0, 'minio', 'https://api.github.com/repos/minio/minio/releases/latest', 1, 0, ''),
('CURL', '/usr/local/bin/mc', 'Minio Client', 'latest', 0, 'mc', 'https://api.github.com/repos/minio/mc/releases/latest', 1, 0, ''),
('CURL', '/usr/local/bin/goofys', 'Goofys', 'v0.24.0', 0, 'goofys', 'https://github.com/kahing/goofys/releases/download/v0.23.1/goofys', 1, 0, ''),
('TARXZ', '<InstallDir>_files', 'Shellcheck', '0.7.1', 0, 'shellcheck-v0.7.1.linux.x86_64.tar.xz', 'https://github.com/koalaman/shellcheck/releases/download/v0.7.1/shellcheck-v0.7.1.linux.x86_64.tar.xz', 1, 0, ''),
...
('TARGZ', '/opt/Lynis', 'Lynis', '3.0.1', 0, 'lynis_v3.0.1.tar.gz', 'https://downloads.cisofy.com/lynis/lynis-3.0.1.tar.gz', 1, 0, ''),
...
('TARGZ', '<InstallDir>/sources/rkhunter', 'RKHunter', '1.4.6', 0, 'rkhunter_v1.4.6.tar.gz', 'https://github.com/toulousain79/MySB_files/raw/v7.3/rkhunter_v1.4.6.tar.gz', 1, 0, ''),
('DEB', '<InstallDir>_files', 'GeoIPupdate', '4.5.0', 0, 'geoipupdate_4.5.0_linux_amd64.deb', 'https://github.com/maxmind/geoipupdate/releases/download/v4.5.0/geoipupdate_4.5.0_linux_amd64.deb', 1, 0, ''),
...
('TARGZ', '<InstallDir>/sources/netdata', 'NetData', '1.26.0', 0, 'netdata_v1.26.0.tar.gz', 'https://github.com/netdata/netdata/releases/download/v1.26.0/netdata-v1.26.0.tar.gz', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/nc', 'NextCloud', '20.0.1', 0, 'nextcloud_v20.0.1.zip', 'https://download.nextcloud.com/server/releases/nextcloud-20.0.1.zip', 1, 0, '');
