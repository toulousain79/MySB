...
('ZIP', '<InstallDir>/web/apps/ru', 'ruTorrent', '3.9_ec8d8f1', 1, 'ruTorrent_v3.9_ec8d8f1.zip', 'https://github.com/toulousain79/MySB_files/raw/#develop#/ruTorrent_v3.9_ec8d8f1.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/ru/plugins/filemanager', 'ruTorrent Plugin FileManager', '0.09', 0, 'filemanager_v0.09.zip', 'https://github.com/toulousain79/MySB_files/raw/#develop#/filemanager_v0.09.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileupload', 'ruTorrent Plugin FileUpload', '0.02', 0, 'fileupload_v0.02.zip', 'https://github.com/toulousain79/MySB_files/raw/#develop#/fileupload_v0.02.zip', 0, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileshare', 'ruTorrent Plugin FileShare', '1.0', 0, 'fileshare_v1.0.zip', 'https://github.com/toulousain79/MySB_files/raw/#develop#/fileshare_v0.03.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/mediastream', 'ruTorrent Plugin MediaStream', '0.01', 0, 'mediastream_v0.01.zip', 'https://github.com/toulousain79/MySB_files/raw/#develop#/mediastream_v0.01.zip', 0, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/ru/plugins/pausewebui', 'ruTorrent Plugin Pause WebUI', '1.2', 0, 'pausewebui_v1.2.zip', 'https://github.com/toulousain79/MySB_files/raw/#develop#/pausewebui_v1.2.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/wolf', 'Wolf CMS', '0.8.3.1', 1, 'wolf_v0.8.3.1.zip', 'https://github.com/toulousain79/MySB_files/raw/#develop#/wolf_v0.8.3.1.zip', 1, 0, ''),
...
('TARGZ', '<InstallDir>/sources/rkhunter', 'RKHunter', '1.4.6', 0, 'rkhunter_v1.4.6.tar.gz', 'https://github.com/toulousain79/MySB_files/raw/#develop#/rkhunter_v1.4.6.tar.gz', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/nc', 'NextCloud', '16.0.3', 0, 'nextcloud_v16.0.3.zip', 'https://download.nextcloud.com/server/releases/nextcloud-16.0.3.zip', 1, 0, '');
