...
INSERT INTO [repositories] ([id_repositories], [type], [dir], [name], [version], [file], [old_file], [url], [active]) VALUES (5, 'TARGZ', '/web/rutorrent/plugins/lbll-suite', 'ruTorrent Plugin tAdd-Labels', 1.1, 'tadd-labels_1.1.tar.gz', 'lbll-suite_0.8.1.tar.gz', 'http://rutorrent-tadd-labels.googlecode.com/files/tadd-labels_1.1.tar.gz', 1);
...
INSERT INTO [repositories] ([id_repositories], [type], [dir], [name], [version], [file], [old_file], [url], [active]) VALUES (15, 'TARGZ', '/sources/nodejs', 'NodeJS', '0.12.2', 'node-v0.12.2.tar.gz', 'node_v0.10.35.tar.gz', 'http://nodejs.org/dist/v0.12.2/node-v0.12.2.tar.gz', 1);
