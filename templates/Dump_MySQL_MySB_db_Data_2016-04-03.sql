...
(16, 'CURL', '/usr/bin/composer', 'Composer', '1.0.2', 'composer.phar', '', 'https://getcomposer.org/installer', 1),
...
(22, 'GIT', '/sources/libsodium', 'Libsodium', '1.0.10', 'libsodium_v1.0.10.zip', 'libsodium_v1.0.4.zip', 'https://github.com/jedisct1/libsodium', 1),
...
(28, 'ZIP', '/sources/xmlrpc-c', 'XMLRPC', '1.42.0', 'xmlrpc-c_v1.42.0.zip', 'xmlrpc-c_v1.41.02.zip', 'https://github.com/toulousain79/MySB/raw/v3.4/files/xmlrpc-c_v1.42.0.zip', 1),
(29, 'GIT', '/web/loadavg', 'LoadAvg', '2.2', 'loadavg_v2.2.zip', '', 'https://github.com/loadavg/loadavg.git', 1),
(30, 'ZIP', '/web/owncloud', 'ownCloud', '9.0.1', 'owncloud_v9.0.1.zip', 'owncloud_v8.2.2.zip', 'https://download.owncloud.org/community/owncloud-9.0.1.zip', 1),
