...
(10, 'SVN', '/web/rutorrent/plugins/filemanager', 'ruTorrent Plugin FileManager', '0.09', 'filemanager_v0.09.zip', '0', 'https://github.com/nelu/rutorrent-thirdparty-plugins/trunk/filemanager', 1),
(11, 'SVN', '/web/rutorrent/plugins/fileupload', 'ruTorrent Plugin FileUpload', '0.02', 'fileupload_v0.02.zip', '0', 'https://github.com/nelu/rutorrent-thirdparty-plugins/trunk/fileupload', 1),
(12, 'SVN', '/web/rutorrent/plugins/fileshare', 'ruTorrent Plugin FileShare', '1.0', 'fileshare_v1.0.zip', '0', 'https://github.com/nelu/rutorrent-thirdparty-plugins/trunk/fileshare', 1),
(13, 'SVN', '/web/rutorrent/plugins/mediastream', 'ruTorrent Plugin MediaStream', '0.01', 'mediastream_v0.01.zip', '0', 'https://github.com/nelu/rutorrent-thirdparty-plugins/trunk/mediastream', 1),
...
(18, 'GIT', '/web/rutorrent/plugins/autodl-irssi', 'ruTorrent Plugin Autodl-irssi', '1.52', 'autodl_v1.52.zip', '0', 'https://github.com/autodl-community/autodl-rutorrent.git', 0),
...
(21, 'GIT', '/sources/plowshare', 'Plowshare', '2.1.1', 'Plowshare_v2.1.1.zip', '0', 'https://github.com/mcrapet/plowshare.git', 1),
(22, 'CURL', '/usr/bin/composer', 'Composer', '1.0.2', 'composer.phar', '0', 'https://getcomposer.org/installer', 1),
(23, 'TARGZ', '/sources/nodejs', 'NodeJS', '0.12.3', 'node_v0.12.13.tar.gz', '0', 'https://nodejs.org/dist/latest-v0.12.x/node-v0.12.13.tar.gz', 1),
...
(25, 'GIT', '/web/Cakebox-light', 'Cakebox-Light', '1.8.3', 'cakebox-light_v1.8.3.zip', '0', 'https://github.com/Cakebox/Cakebox-light.git', 1),
(26, 'GIT', '/sources/libsodium', 'Libsodium', '1.0.10', 'libsodium_v1.0.10.zip', '0', 'https://github.com/jedisct1/libsodium', 1),
(27, 'TARGZ', '/sources/dnscrypt-proxy', 'DNScrypt-proxy', '1.6.1', 'dnscrypt-proxy_v1.6.1.tar.gz', '0', 'http://download.dnscrypt.org/dnscrypt-proxy/dnscrypt-proxy-1.6.1.tar.gz', 1),
...
(32, 'ZIP', '/sources/xmlrpc-c', 'XMLRPC', '1.42.0', 'xmlrpc-c_v1.42.0.zip', '0', 'https://github.com/toulousain79/MySB/raw/v3.4/files/xmlrpc-c_v1.42.0.zip', 1),
(33, 'GIT', '/web/loadavg', 'LoadAvg', '2.2', 'loadavg_v2.2.zip', '0', 'https://github.com/loadavg/loadavg.git', 1),
(34, 'ZIP', '/web/owncloud', 'ownCloud', '9.0.1', 'owncloud_v9.0.1.zip', '0', 'https://download.owncloud.org/community/owncloud-9.0.1.zip', 1),
