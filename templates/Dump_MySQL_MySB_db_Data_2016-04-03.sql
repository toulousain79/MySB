...
(5, 'TARGZ', '/web/rutorrent/plugins/nfo', 'ruTorrent Plugin NFO', '1337', 'nfo_v1337.tar.gz', '0', 'http://srious.biz/nfo.tar.gz', 1),
(6, 'GIT', '/web/rutorrent/plugins/ratiocolor', 'ruTorrent Plugin RatioColor', '0.5', 'ratiocolor_v0.5.zip', '0', 'https://github.com/Gyran/rutorrent-ratiocolor', 1),
(7, 'SVN', '/web/rutorrent/plugins/filemanager', 'ruTorrent Plugin FileManager', '0.09', 'filemanager_v0.09.zip', '0', 'http://svn.rutorrent.org/svn/filemanager/trunk/filemanager', 1),
(8, 'SVN', '/web/rutorrent/plugins/fileupload', 'ruTorrent Plugin FileUpload', '0.02', 'fileupload_v0.02.zip', '0', 'http://svn.rutorrent.org/svn/filemanager/trunk/fileupload', 0),
(9, 'SVN', '/web/rutorrent/plugins/fileshare', 'ruTorrent Plugin FileShare', '0.03', 'fileshare_v0.03.zip', '0', 'http://svn.rutorrent.org/svn/filemanager/trunk/fileshare', 1),
(10, 'SVN', '/web/rutorrent/plugins/mediastream', 'ruTorrent Plugin MediaStream', '0.01', 'mediastream_v0.01.zip', '0', 'http://svn.rutorrent.org/svn/filemanager/trunk/mediastream', 1),
(11, 'TARGZ', '/web/rutorrent/plugins/stream', 'ruTorrent Plugin Stream', '1.0', 'stream_v1.0.tar.gz', '0', 'https://rutorrent-stream-plugin.googlecode.com/files/stream.tar.gz', 1),
(12, 'ZIP', '/web/rutorrent/plugins/pausewebui', 'ruTorrent Plugin Pause WebUI', '1.2', 'pausewebui_v1.2.zip', '0', 'https://rutorrent-pausewebui.googlecode.com/files/pausewebui.1.2.zip', 1),
(13, 'GIT', '/web/rutorrent/plugins/mobile', 'ruTorrent Plugin Mobile', '1.0', 'mobile_v1.0.zip', '0', 'https://github.com/xombiemp/rutorrentMobile.git', 1),
(14, 'GIT', '/web/rutorrent/plugins/autodl-irssi', 'ruTorrent Plugin Autodl-irssi', '1.52', 'autodl_v1.52.zip', '0', 'https://github.com/autodl-community/autodl-rutorrent.git', 0),
(15, 'GIT', '/sources/plowshare', 'Plowshare', '2.1.1', 'Plowshare_v2.1.1.zip', '0', 'https://github.com/mcrapet/plowshare.git', 1),
(16, 'CURL', '/usr/bin/composer', 'Composer', '1.0.2', 'composer.phar', '0', 'https://getcomposer.org/installer', 1),
(17, 'TARGZ', '/sources/nodejs', 'NodeJS', '0.12.3', 'node_v0.12.13.tar.gz', '0', 'https://nodejs.org/dist/latest-v0.12.x/node-v0.12.13.tar.gz', 1),
(18, 'GIT', '/web/seedbox-manager', 'Seedbox-Manager', '2.4.4', 'seedbox-manager_v2.4.4.zip', '0', 'https://github.com/Magicalex/seedbox-manager.git', 1),
...
(20, 'GIT', '/web/Cakebox-light', 'Cakebox-Light', '1.8.3', 'cakebox-light_v1.8.3.zip', '0', 'https://github.com/Cakebox/Cakebox-light.git', 1),
(21, 'GIT', '/web/rutorrent/plugins/linkcakebox', 'ruTorrent Plugin Link Cakebox', '1.0', 'linkcakebox_v1.0.zip', '0', 'https://github.com/Cakebox/linkcakebox.git', 1),
(22, 'GIT', '/sources/libsodium', 'Libsodium', '1.0.10', 'libsodium_v1.0.10.zip', '0', 'https://github.com/jedisct1/libsodium', 1),
(23, 'TARGZ', '/sources/dnscrypt-proxy', 'DNScrypt-proxy', '1.6.1', 'dnscrypt-proxy_v1.6.1.tar.gz', '0', 'http://download.dnscrypt.org/dnscrypt-proxy/dnscrypt-proxy-1.6.1.tar.gz', 1),
(24, 'WBM', '/files', 'OpenVPNadmin WebMin', '2.6', 'openvpn_v2.6.wbm', '0', 'http://www.openit.it/downloads/OpenVPNadmin/openvpn-2.6.wbm.gz', 1),
(25, 'WBM', '/files', 'Nginx Webmin Module', '0.0.8', 'nginx_v0.08.wbm', '0', 'http://www.justindhoffman.com/sites/justindhoffman.com/files/nginx-0.08.wbm__0.gz', 1),
(26, 'TARGZ', '/sources/libtorrent', 'LibTorrent', '0.13.6', 'libtorrent_v0.13.6.tar.gz', '0', 'http://rtorrent.net/downloads/libtorrent-0.13.6.tar.gz', 1),
(27, 'TARGZ', '/sources/rtorrent', 'rTorrent', '0.9.6', 'rtorrent_v0.9.6.tar.gz', '0', 'http://rtorrent.net/downloads/rtorrent-0.9.6.tar.gz', 1),
(28, 'ZIP', '/sources/xmlrpc-c', 'XMLRPC', '1.42.0', 'xmlrpc-c_v1.42.0.zip', '0', 'https://github.com/toulousain79/MySB/raw/v3.4/files/xmlrpc-c_v1.42.0.zip', 1),
(29, 'GIT', '/web/loadavg', 'LoadAvg', '2.2', 'loadavg_v2.2.zip', '0', 'https://github.com/loadavg/loadavg.git', 1),
(30, 'ZIP', '/web/owncloud', 'ownCloud', '9.0.1', 'owncloud_v9.0.1.zip', '0', 'https://download.owncloud.org/community/owncloud-9.0.1.zip', 1),
(31, 'GIT', '/sources/letsencrypt', 'Lets Encrypt', '0.5.0', 'LetsEncrypt_v0.5.0.zip', '0', 'https://github.com/letsencrypt/letsencrypt', 1),
(32, 'TARGZ', '/sources/rkhunter', 'RKHunter', '1.4.2', 'rkhunter_v1.4.2.tar.gz', '0', 'http://downloads.sourceforge.net/project/rkhunter/rkhunter/1.4.2/rkhunter-1.4.2.tar.gz?r=&ts=1456674223&use_mirror=freefr', 1);
...
(2, 'acme-staging.api.letsencrypt.org', ''),
