...
CREATE TABLE IF NOT EXISTS `dnscrypt_config` (
  ...
  `random` varchar(3) NOT NULL DEFAULT 'yes',
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `users_passwd` varchar(32) NOT NULL DEFAULT '',
  `rpc` varchar(64) NOT NULL DEFAULT '',
  `sftp` tinyint(1) NOT NULL DEFAULT '1',
  `sudo` tinyint(1) NOT NULL DEFAULT '0',
  `admin` tinyint(1) NOT NULL DEFAULT '0',
  `scgi_port` varchar(5) NOT NULL DEFAULT '',
  `rtorrent_port` varchar(5) NOT NULL DEFAULT '',
  `home_dir` varchar(128) NOT NULL DEFAULT '',
