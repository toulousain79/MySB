...
(10, 'SVN', '/web/rutorrent/plugins/filemanager', 'ruTorrent Plugin FileManager', '0.09', 'filemanager_v0.09.zip', '0', 'https://github.com/nelu/rutorrent-thirdparty-plugins/branches/master/filemanager', 1),
...
(26, 'TARGZ', '/sources/libsodium', 'Libsodium', '1.0.10', 'libsodium_v1.0.10.tar.gz', '0', 'https://download.libsodium.org/libsodium/releases/libsodium-1.0.10.tar.gz', 1),
(27, 'TARGZ', '/sources/dnscrypt-proxy', 'DNScrypt-proxy', '1.6.1', 'dnscrypt-proxy_v1.6.1.tar.gz', '0', 'https://download.dnscrypt.org/dnscrypt-proxy/dnscrypt-proxy-1.6.1.tar.gz', 1),
...
(32, 'SVN', '/sources/xmlrpc-c', 'XMLRPC', '1.43.0', 'xmlrpc-c_v1.43.0.zip', '0', 'http://svn.code.sf.net/p/xmlrpc-c/code/stable', 1),
...
(35, 'GIT', '/sources/letsencrypt', 'Lets Encrypt', '0.5.0', 'LetsEncrypt_v0.5.0.zip', '0', 'https://github.com/certbot/certbot', 1),
