...
(18, 'GIT', '/web/rutorrent/plugins/linkseedboxmanager', 'ruTorrent Plugin Link Manager', '1.0', 0, 'linkseedboxmanager_v1.0.zip', 'https://github.com/Hydrog3n/linkseedboxmanager.git', 1, 0, ''),
(19, 'GIT', '/web/rutorrent/plugins/linkcakebox', 'ruTorrent Plugin Link Cakebox', '1.0', 0, 'linkcakebox_v1.0.zip', 'https://github.com/Cakebox/linkcakebox.git', 1, 0, ''),
(20, 'GIT', '/sources/plowshare', 'Plowshare', '2.1.6', 0, 'Plowshare_v2.1.6.zip', 'https://github.com/mcrapet/plowshare.git', 1, 0, ''),
(21, 'CURL', '/usr/bin/composer', 'Composer', '1.2.3', 0, 'composer.phar', 'https://getcomposer.org/installer', 1, 0, ''),
(22, 'TARGZ', '/sources/nodejs', 'NodeJS', '0.12.17', 0, 'node_v0.12.17.tar.gz', 'https://nodejs.org/dist/v0.12.17/node-v0.12.17.tar.gz', 1, 0, ''),
(23, 'GIT', '/web/seedbox-manager', 'Seedbox-Manager', '2.5.0', 0, 'seedbox-manager_v2.5.0.zip', 'https://github.com/Magicalex/seedbox-manager.git', 1, 0, ''),
(24, 'GIT', '/web/cakebox-light', 'Cakebox-Light', '1.8.6', 0, 'cakebox-light_v1.8.6.zip', 'https://github.com/Cakebox/Cakebox-light.git', 1, 0, ''),
...
(33, 'ZIP', '/web/owncloud', 'ownCloud', '9.1.2', 0, 'owncloud_v9.1.2.zip', 'https://download.owncloud.org/community/owncloud-9.1.2.zip', 1, 0, ''),
