...
(10, 'SVN', '/web/rutorrent/plugins/filemanager', 'ruTorrent Plugin FileManager', '0.09', 'filemanager_v0.09.zip', '0', 'https://github.com/nelu/rutorrent-thirdparty-plugins/trunk/fileupload', 1),
(11, 'SVN', '/web/rutorrent/plugins/fileupload', 'ruTorrent Plugin FileUpload', '0.02', 'fileupload_v0.02.zip', '0', 'https://github.com/nelu/rutorrent-thirdparty-plugins/branches/master/fileupload', 1),
(12, 'SVN', '/web/rutorrent/plugins/fileshare', 'ruTorrent Plugin FileShare', '1.0', 'fileshare_v1.0.zip', '0', 'https://github.com/nelu/rutorrent-thirdparty-plugins/branches/master/fileshare', 1),
(13, 'SVN', '/web/rutorrent/plugins/mediastream', 'ruTorrent Plugin MediaStream', '0.01', 'mediastream_v0.01.zip', '0', 'https://github.com/nelu/rutorrent-thirdparty-plugins/branches/master/mediastream', 1),
...
(21, 'GIT', '/usr/local/src/plowshare', 'Plowshare', '2.1.4', 'Plowshare_v2.1.4.zip', '0', 'https://github.com/mcrapet/plowshare.git', 1),
(22, 'CURL', '/usr/bin/composer', 'Composer', '1.1.0-RC', 'composer.phar', '0', 'https://getcomposer.org/installer', 1),
(23, 'TARGZ', '/usr/local/src/nodejs', 'NodeJS', '0.12.14', 'node_v0.12.14.tar.gz', '0', 'https://nodejs.org/dist/latest-v0.12.x/node-v0.12.14.tar.gz', 1),
(24, 'GIT', '/web/seedbox-manager', 'Seedbox-Manager', '2.4.4', 'seedbox-manager_v2.4.4.zip', '0', 'https://github.com/Magicalex/seedbox-manager.git', 1),
(25, 'GIT', '/web/cakebox-light', 'Cakebox-Light', '1.8.6', 'cakebox_v1.8.6.zip', '0', 'https://github.com/Cakebox/Cakebox-light.git', 1),
(26, 'GIT', '/usr/local/src/libsodium', 'Libsodium', '1.0.10', 'libsodium_v1.0.10.zip', '0', 'https://github.com/jedisct1/libsodium', 1),
(27, 'GIT', '/usr/local/src/dnscrypt-proxy', 'DNScrypt-proxy', '1.6.1', 'dnscrypt-proxy_v1.6.1.zip', '0', 'https://github.com/jedisct1/dnscrypt-proxy.git', 1),
...
(30, 'TARGZ', '/usr/local/src/libtorrent', 'LibTorrent', '0.13.6', 'libtorrent_v0.13.6.tar.gz', '0', 'http://rtorrent.net/downloads/libtorrent-0.13.6.tar.gz', 1),
(31, 'TARGZ', '/usr/local/src/rtorrent', 'rTorrent', '0.9.6', 'rtorrent_v0.9.6.tar.gz', '0', 'http://rtorrent.net/downloads/rtorrent-0.9.6.tar.gz', 1),
(32, 'SVN', '/usr/local/src/xmlrpc-c', 'XMLRPC', '1.43.0', 'xmlrpc-c_v1.43.0.zip', '0', 'http://svn.code.sf.net/p/xmlrpc-c/code/stable', 1),
...
(35, 'GIT', '/usr/local/src/letsencrypt', 'Lets Encrypt', '0.5.0', 'LetsEncrypt_v0.5.0.zip', '0', 'https://github.com/letsencrypt/letsencrypt', 1),
(36, 'TARGZ', '/usr/local/src/rkhunter', 'RKHunter', '1.4.2', 'rkhunter_v1.4.2.tar.gz', '0', 'http://downloads.sourceforge.net/project/rkhunter/rkhunter/1.4.2/rkhunter-1.4.2.tar.gz?r=&ts=1456674223&use_mirror=freefr', 1);
