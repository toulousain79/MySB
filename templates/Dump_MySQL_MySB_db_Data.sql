...
('ZIP', '<InstallDir>/web/apps/ru/plugins/filemanager', 'ruTorrent Plugin FileManager', '0.09', 0, 'filemanager_v0.09.zip', 'https://github.com/toulousain79/MySB/raw/v5.1/files/filemanager_v0.09.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileupload', 'ruTorrent Plugin FileUpload', '0.02', 0, 'fileupload_v0.02.zip', 'https://github.com/toulousain79/MySB/raw/v5.1/files/fileupload_v0.02.zip', 0, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileshare', 'ruTorrent Plugin FileShare', '1.0', 0, 'fileshare_v1.0.zip', 'https://github.com/toulousain79/MySB/raw/v5.1/files/fileshare_v0.03.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/mediastream', 'ruTorrent Plugin MediaStream', '0.01', 0, 'mediastream_v0.01.zip', 'https://github.com/toulousain79/MySB/raw/v5.1/files/mediastream_v0.01.zip', 1, 0, ''),
...
('CURL', '/usr/bin/composer', 'Composer', '1.5.2', 0, 'composer.phar', 'https://getcomposer.org/download/1.5.2/composer.phar', 1, 0, ''),
...
('TARGZ', '<InstallDir>/sources/libsodium', 'Libsodium', '1.0.15', 0, 'libsodium_v1.0.15.tar.gz', 'https://download.libsodium.org/libsodium/releases/libsodium-1.0.15.tar.gz', 1, 0, ''),
('TARGZ', '<InstallDir>/sources/minisign', 'Minisign', '0.7.11', 0, 'minisign_v0.7.11.tar.gz', 'https://github.com/jedisct1/minisign/tarball/master', 1, 0, ''),
