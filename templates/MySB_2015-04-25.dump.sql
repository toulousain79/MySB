...
INSERT INTO [repositories] ([id_repositories], [type], [dir], [name], [version], [file], [old_file], [url], [active]) VALUES (9, 'SVN', '/web/rutorrent/plugins/fileshare', 'ruTorrent Plugin FileShare', 0.03, 'fileshare_v0.03', '', 'http://svn.rutorrent.org/svn/filemanager/trunk/fileshare', 1);
...
INSERT INTO [repositories] ([id_repositories], [type], [dir], [name], [version], [file], [old_file], [url], [active]) VALUES (12, 'SVN', '/web/rutorrent/plugins/pausewebui', 'ruTorrent Plugin Pause WebUI', 1.2, 'pausewebui_v1.2', '', 'http://rutorrent-pausewebui.googlecode.com/svn/trunk/', 1);
