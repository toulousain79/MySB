...
--
-- Client: localhost
-- Généré le: Dim 27 Septembre 2015 à 19:28
...
CREATE TABLE IF NOT EXISTS `dnscrypt_resolvers` (
  ...
  `no_logs` tinyint(1) NOT NULL DEFAULT '0',
  `namecoin` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `scgi_port` smallint(5) NOT NULL,
  `rtorrent_port` smallint(5) NOT NULL,
