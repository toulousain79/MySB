...
CREATE TABLE services ( 
    ...
    ports_tcp_sec VARCHAR( 32 ),
    ports_tcp_ter VARCHAR( 32 ),
...
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (1, 'Seedbox-Manager', '', '', '', '', '', 0, '', '', '');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (2, 'CakeBox-Light', '', 8887, '', '', '', 0, '', '', '');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (3, 'Plex Media Server', '/etc/default/plexmediaserver', '32400 32469', '', '', '1900 5353 2410 32412 32413 32414', 0, '', 'service plexmediaserver restart', 'service plexmediaserver restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (4, 'Webmin', '/etc/webmin', 8890, '', '', '', 0, '', 'service webmin restart', 'service webmin restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (5, 'OpenVPN', '/etc/openvpn', '8893 8894', '', '', '', 0, 'openvpn', 'service openvpn reload', 'service openvpn restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (6, 'LogWatch', '', '', '', '', '', 0, '', '', '');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (7, 'Fail2Ban', '/etc/fail2ban', '', '', '', '', 0, 'fail2ban', 'service fail2ban reload', 'service fail2ban restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (8, 'PeerGuardian', '/etc/pgl', '', '', '', '', 0, 'pglcmd', 'pglcmd reload', 'pglcmd restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (9, 'rTorrent Block List', '', '', '', '', '', 1, '', '', '');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (10, 'DNScrypt-proxy', 'dnscrypt-proxy', '', '', '', '53 54 443 2053 5353', 0, 'dnscrypt-proxy', 'service dnscrypt-proxy restart', 'service dnscrypt-proxy restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (11, 'CRON', 'crontab', '', '', '', '', 1, 'cron', 'service cron reload', 'service cron restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (12, 'NginX', '/etc/nginx', 8889, 8888, '', '', 1, 'nginx', 'service nginx reload', 'service nginx restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (13, 'SSH', '/etc/ssh', 8892, '', '', '', 1, 'ssh', 'service ssh reload', 'service ssh restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (14, 'VSFTPd', '/etc/vsftpd', 8891, 8800, '65000:65535', '', 1, 'vsftpd', 'service vsftpd reload', 'service vsftpd restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (15, 'PHP5-FPM', '/etc/php5', '', '', '', '', 1, 'php5-fpm', 'service php5-fpm reload', 'service php5-fpm restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (16, 'Postfix', '/etc/postfix', '', '', '', '', 0, 'postfix', 'service postfix reload', 'service postfix restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (17, 'Networking', '/etc/network', '', '', '', '', 1, '', 'service networking reload', 'service networking restart');
INSERT INTO [services] ([id_services], [serv_name], [ident], [ports_tcp], [ports_tcp_sec], [ports_tcp_ter], [ports_udp], [is_installed], [bin], [cmd_reload], [cmd_restart]) VALUES (18, 'Samba', '/etc/samba', '', '', '', '', 0, 'samba', 'service samba reload', 'service samba restart');
