--
-- Fichier généré par SQLiteStudio v3.0.6sur dim. juil. 5 14:52:44 2015
--
...
INSERT INTO repositories (id_repositories, type, dir, name, version, file, old_file, url, active) VALUES (15, 'TARGZ', '/sources/plowshare', 'Plowshare4', '4', 'Plowshare4.tar.gz', '', 'https://github.com/toulousain79/MySB/blob/v2.2/files/Plowshare4.tar.gz?raw=true', 1);
...
INSERT INTO repositories (id_repositories, type, dir, name, version, file, old_file, url, active) VALUES (17, 'TARGZ', '/sources/nodejs', 'NodeJS', '0.12.4', 'node-v0.12.4.tar.gz', 'node-v0.12.2.tar.gz', 'http://nodejs.org/dist/v0.12.4/node-v0.12.4.tar.gz', 1);
INSERT INTO repositories (id_repositories, type, dir, name, version, file, old_file, url, active) VALUES (18, 'GIT', '/web/seedbox-manager', 'Seedbox-Manager', '2.4.3', 'seedbox-manager_v2.4.3.zip', '', 'https://github.com/Magicalex/seedbox-manager.git', 1);
...
INSERT INTO repositories (id_repositories, type, dir, name, version, file, old_file, url, active) VALUES (22, 'GIT', '/sources/libsodium', 'Libsodium', '1.0.2', 'libsodium_v1.0.2.zip', '', 'https://github.com/jedisct1/libsodium', 1);
INSERT INTO repositories (id_repositories, type, dir, name, version, file, old_file, url, active) VALUES (23, 'TARGZ', '/sources/dnscrypt-proxy', 'DNScrypt-proxy', '1.5.0', 'dnscrypt-proxy_v1.5.0.tar.gz', 'dnscrypt-proxy_v1.4.3.tar.gz', 'http://download.dnscrypt.org/dnscrypt-proxy/dnscrypt-proxy-1.4.3.tar.gz', 1);
...
INSERT INTO repositories (id_repositories, type, dir, name, version, file, old_file, url, active) VALUES (29, 'SVN', '/sources/xmlrpc-c', 'XMLRPC', '1.41.02', 'xmlrpc-c_v1.41.02.zip', '', 'http://svn.code.sf.net/p/xmlrpc-c/code/advanced', 1);
...
-- Table: services
CREATE TABLE [services] ([id_services] INTEGER PRIMARY KEY ON CONFLICT IGNORE AUTOINCREMENT NOT NULL ON CONFLICT ABORT UNIQUE ON CONFLICT ABORT, [serv_name] VARCHAR (32) NOT NULL ON CONFLICT ABORT UNIQUE ON CONFLICT IGNORE, [bin] VARCHAR (32), [port_tcp1] VARCHAR (11), [port_tcp2] VARCHAR (11), [port_tcp3] VARCHAR (11), [ports_tcp_list] VARCHAR (32), [port_udp1] VARCHAR (11), [port_udp2] VARCHAR (11), [port_udp3] VARCHAR (11), [ports_udp_list] VARCHAR (32), [to_install] BOOLEAN (1) DEFAULT(0), [is_installed] BOOLEAN NOT NULL ON CONFLICT ABORT DEFAULT(0));
