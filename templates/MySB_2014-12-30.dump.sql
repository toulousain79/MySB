...
INSERT INTO [repositories] ([id_repositories], [type], [dir], [name], [version], [file], [old_file], [url], [active]) VALUES (17, 'GIT', '/etc/MySB/web/rutorrent/plugins/linkmanager', 'ruTorrent Plugin Link Manager', null, null, null, 'https://github.com/Hydrog3n/linkseedboxmanager.git', 1);
...
INSERT INTO [repositories] ([id_repositories], [type], [dir], [name], [version], [file], [old_file], [url], [active]) VALUES (25, 'TARGZ', '/etc/MySB/sources/libtorrent_v0.13.4', 'LibTorrent', '0.13.4', 'libtorrent-0.13.4.tar.gz', null, 'http://libtorrent.rakshasa.no/downloads/libtorrent-0.13.4.tar.gz', 0);
INSERT INTO [repositories] ([id_repositories], [type], [dir], [name], [version], [file], [old_file], [url], [active]) VALUES (26, 'TARGZ', '/etc/MySB/sources/rorrent_v0.9.4', 'rTorrent', '0.9.4', 'rtorrent-0.9.4.tar.gz', null, 'http://libtorrent.rakshasa.no/downloads/rtorrent-0.9.4.tar.gz', 0);
